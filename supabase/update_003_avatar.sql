-- Schätzduell — incremental update: customizable avatars (background/skin/hair).
-- Run this once in the SQL Editor if you already ran combined_setup.sql or update_002_matchmaking.sql.
